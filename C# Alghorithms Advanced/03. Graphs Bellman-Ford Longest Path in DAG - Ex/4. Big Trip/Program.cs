...
namespace _4._Big_Trip
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // reversed the Bellman-Ford algorithm instead of implementing the Dijkstra-like algorithm for longest path
            BellmanFordLongestPath(nodesCount, source, destination);
        }

        private static void BellmanFordLongestPath(int nodesCount, int source, int destination)
        {
